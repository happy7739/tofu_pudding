...
<section class="banner-bottom">
			...
			<div class="address row">
				<div class="col-lg-4 address-grid" data-aos="zoom-in">
					<div class="row address-info">
						...
						<div class="col-md-8 address-right text-left">
							<h6>Address</h6>
							<p>
								<?php echo htmlentities($config['address']); ?>
							</p>
						</div>
					</div>
				...
				<div class="col-lg-4 address-grid" data-aos="zoom-in">
					<div class="row address-info">
						...
						<div class="col-md-8 address-right text-left">
							<h6>Phone</h6>
							<p style="font-size: 2em;"><?php echo htmlentities($config['mobile']); ?></p>
						</div>
	...
	<div class="container">
		<div class="contact_grid_right">
			<form action="<?php echo url('index/Contact/insert_message'); ?>" method="post" id="addForm">
